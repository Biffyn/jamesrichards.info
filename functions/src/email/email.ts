...
export const sendContactEmail = functions.https.onRequest((req: functions.Request, res: functions.Response) => {
  corsHandler(req, res, () => {
    ...
    const msg = {
      ...
      from: { name: 'JamesRichards.dev', email: 'noreply@jamesrichards.dev' },
